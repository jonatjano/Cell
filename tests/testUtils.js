...
describe("utils", () => {
	...
	describe("deepFreeze", () => {
		...
		it("should work with deeply recursive data", () => {
			...
			expect(Object.isFrozen(b)).to.be.true
			expect(Object.isFrozen(b.c)).to.be.true
			expect(Object.isFrozen(b.c.b)).to.be.true
			expect(Object.isFrozen(b.c.b.c)).to.be.true
			expect(b.c.b).to.be.equal(b)
			expect(b.c.b.c).to.be.equal(b.c)
			expect(b.c).to.be.equal(c)
		})
	})
})
